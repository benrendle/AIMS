...
class Track:
    ...
    def __init__(self, aModel, grid_params):
        ...
        self.params = list(map(aModel.string_to_param,self.grid_params))
    ...
    def duplicate_ages(self):
        ...
        if len(self.models) > 1:
            ...
            return [True, self.models[0].name, self.models[0].name]
...
class Model_grid:
    ...
    def __init__(self):
        ...
        set of user gridparameters in `AIMS_configure.py`
        """
