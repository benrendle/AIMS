...
classic_weight = 1.0 # will be reset below
seismic_weight = 0.0 # will be reset below

def find_weights(nclassic, nseismic):
    global classic_weight, seismic_weight
    #classic_weight = 1.0/(nclassic - 1.0)
    #seismic_weight = 1.0/(nseismic - 1.0)
    classic_weight = 1.0
    seismic_weight = 0.0
...
#       or "Sonoi2015_2"
output_params = ("Radius","Teff","Luminosity","Rho","log_g","Fe_H","Y","Z")
